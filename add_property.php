...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO properties (property_name, owner_username, location, rent, rooms, features, status) VALUES (?,?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("sssdiss", $property_name, $username, $location, $rent, $rooms, $features, $status);
